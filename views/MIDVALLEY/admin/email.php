...
$yourGmailAddress = 'teamspartanb59@gmail.com';
$yourGmailPassword = 'TEAM@spartanb59';
...
$midValley = new MidValley();

if(isset($_REQUEST['list'])) {
    $list = 1;
    $recordSet = $midValley->index();

}
else {
    $list= 0;
    $midValley->setData($_REQUEST);
    $singleItem = $midValley->view();
}
...
<head>
    <title>Email This To A Flat Owner</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="../../../resources/images/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="../../../resources/images/bootstrap/css/main.css">
    <script src="../../../resources/images/bootstrap/js/bootstrap.min.js"></script>
...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation">
                <a href="mid_index.php"><i class="glyphicon glyphicon-chevron-right"></i> Back To List</a>
            </li>
            <li role="presentation">
                <a href=""><i class="glyphicon glyphicon-chevron-right"></i> Return Home</a>
            </li>
        </ul>
    </div>
    ...
    <div class="col-md-10">
        <h2>Email This To A Flat Owner</h2>
...
?>
        ...
        if(isset($_REQUEST['email'])&&isset($_REQUEST['subject'])) {
            ...
            $mail->setFrom($yourGmailAddress, 'Team Spartan');
            //Set an alternative reply-to address
            $mail->addReplyTo($yourGmailAddress, 'Team Spartan');
