...
<div class="container">
    ...
    <table class="table">
        <div class="container">
            <a style="float: left" href="../../MIDVALLEY/user/logreg_index.php" class="btn btn-lg btn-warning"><span class='glyphicon glyphicon-home'></span> Home</a>
            <a style="float: right" href="logreg_index.php" class="btn btn-lg btn-primary"><span class='glyphicon glyphicon-list-alt'></span> Back To List</a>
        </div>
    </table>
    <br/>
